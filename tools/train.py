...
def parse_config():
    ...
    parser.add_argument('--pretrained_model', type=str, help='pretrained_model', default=None)#'/home/niko/Documents/sicherung_trainings/second_1_240308/checkpoint_epoch_15.pth')
...
def train_one_epoch_w_ae(model, optimizer, train_loader, model_func, lr_scheduler, accumulated_iter, optim_cfg,
